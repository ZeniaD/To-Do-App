  ...
  return (
    <>
      {checklist.map((item, index) =>
        <p key={item.id}
           className={`py-2 flex items-center border-dashed border border-darkish-gray last:border-none text-white border-t-0 border-l-0 border-r-0 ${item.isCompleted && "line-through"}`}>
